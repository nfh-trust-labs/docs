...
6. **Handle Delegated Verification Requests**
   - Namespaces that receive delegated domain-attestation requests use the notification and verification-request APIs to review, accept, or reject them
