...
{% step %}
<mark style="color:$primary;">**Claim your namespace**</mark>

Create a namespace and verify it against your domain
{% endstep %}

{% step %}
<mark style="color:$primary;">**Publish your registries**</mark>

Publish your first directory using any schema
{% endstep %}

{% step %}
<mark style="color:$primary;">**Look up and query info using DeDi**</mark>
